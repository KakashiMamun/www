...
class LoginModule {
    ...
    public static function GetUser($email, $password){
        ...
        $sql = 'SELECT * FROM Bang.user where email =\''.$email.'\' and password=\''.$password.'\'';
    ...
    public static function CreateOrUpdateSession($userData,$TTL){
        ...
        $sql = "REPLACE INTO Bang.session_table values($user_id,'$session_key','$user_data',ADDDATE(NOW(),INTERVAL $TTL DAY) );";
...
//    echo $sql;
    ...
    public static function GenerateSessionData($user_id){
        ...
        $sql ="SELECT * FROM Bang.session_table where user_id = $user_id ;";
        $result = ICodeDB::GetResultRow($sql);
        return $result;
    }
