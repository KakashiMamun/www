...
{                                      
    ...
    public static $className='SuperAdministrator';     
            
    public static function Add($superAdministratorId)
    {
        //process password
        return true;
        ...
        $insert="replace into super_administrator (super_administrator_id, inv_companyName, inv_address,inv_state_id, inv_city_id, inv_postcode)
                         values(
                         '$superAdministratorId','".$_POST['companyNameInv']."','$address', '".$_POST['stateIdInv']."','".$_POST['cityIdInv']."',
                         '".$_POST['postcodeInv']."'
                         )";
    ...
    public static function Update($superAdministratorId)
    {      
        return true;
    }              
    public static function Validate()
    {
        ...
        $update=false;
        $delimiter="'";
        if(isset($_POST[SuperAdministrator::$formIdName]) && (int)$_POST[SuperAdministrator::$formIdName]>0) //means update
            $update=true;
        if($update)
        {
            $mustFields=SuperAdministrator::$updateFields;
        }
        else
            $mustFields=SuperAdministrator::$insertFields;
    ...
    {                                               
        $superUsers=User::Get(0,0,'SuperAdministrator', $status);
        $html='';
        //print_r($superUsers);
